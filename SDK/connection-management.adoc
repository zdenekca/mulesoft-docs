...
Reconnection happens each time an operation or message source fails with a ConnectionException, or a ConnectionException can be found on the error’s cause tree. When that happens the runtime will:
