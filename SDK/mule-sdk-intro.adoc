...
Create extensions using the *Mule SDK*, the standard framework used to build components, connectors and packaged functionality for use in Mule 4.

All modules, connectors and pluggable functionality for Mule can generally be considered extensions in Mule 4 terms. The Extensions API is the mechanism used to "discover" extensions for Mule.

[IMPORTANT]
DevKit-built connectors work out of the box with Mule 3.5.3 to Mule 3.9.x. Use *SDK* to build connectors for Mule 4 or later.

== What is an Extension?

An extension is a module that eases the interaction between a Mule application and external resources.

A module facilitates integration with SaaS, web services and other data sources. In Mule 4, connectors to SaaS applications are still considered *cloud connectors*.

== How Does Mule Discover Extensions?
