...
. Create a Mule application in Studio and add an HTTP listener and specify `/get-recently` for the path. If this is your first Mule app, take a look at our link:/getting-started/build-a-hello-world-application[Hello World Application].
