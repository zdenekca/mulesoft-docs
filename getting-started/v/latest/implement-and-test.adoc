...
To create a Studio project for the example T-Shirt API on Anypoint Platform, you first need to set up the `t.shirt.raml` RAML definition according to the instructions in link:/getting-started/create-an-api[Creating an API]
