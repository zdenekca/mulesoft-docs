...
* To deploy Mule on technologies, such as web app servers, see link:/mule-user-guide/v/3.8/deployment-scenarios[Mule Runtime Embedded Deployment Scenarios] and link:/mule-user-guide/v/3.8/configuring-mule-for-different-deployment-scenarios[Configuring Mule for Different Deployment Scenarios]
