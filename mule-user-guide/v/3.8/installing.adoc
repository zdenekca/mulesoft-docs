...
To learn about Mule runtime deployment scenarios using WebLogic, Tomcat, WebSphere, or JBoss see link:/mule-user-guide/v/3.8/deployment-scenarios[Mule Runtime Embedded Deployment Scenarios] in the link:/mule-user-guide/v/3.8/deploying[Deploying] section.
