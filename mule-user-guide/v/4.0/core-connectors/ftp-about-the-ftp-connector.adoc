...
[[short_description]]
The FTP connector handles file transfers over FTP, _[TODO: VERIFY FTPS,]_ and SFTP protocols.
// TODO: VERIFY FTPS
...
include::include_link_list.adoc[tags=ftps-set-up]
//TODO: VERIFY FTPS ABOVE

=== Settings Available to FTP _[TODO: and FTPS?]_
...
include::include_link_list.adoc[tags=create-directory]
