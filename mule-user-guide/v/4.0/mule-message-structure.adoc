...
* The message *data type*, which describes the message format
* The message *payload*, which contains the core information of the Mule message.

A Mule message is, itself, embedded within a *Mule message object*. Some Mule message objects may contain variables, attachments, and exception payloads.
