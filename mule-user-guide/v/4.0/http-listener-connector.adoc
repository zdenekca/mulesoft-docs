...
The *request body* is passed on to the next element of the Mule flow as the _message payload_ of a Mule Message, while headers, query parameters, URI parameters and other elements of the HTTP Request are passed on as _attributes_.
// TODO: Accessing Message attributes using DataWeave.

These properties are accessible within a Mule message from your Mule application.
...
A detailed reference can be found in the link:/mule-user-guide/v/3.8/tuning-performance#connector-level[tunningg performance at the connector level] documentation.
