...
At the simplest level, Mule works by receiving _events_, processing them and routing them to other _endpoints_. +
...
* Define a filters to allow certain *Mule events* to continue to be processed in a *flow* based on certain criteria.
