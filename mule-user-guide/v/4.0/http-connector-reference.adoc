...
// TODO: Reference connectors
Mule Utilities for HTTP Services.

This page serves as a reference for all of the supported attributes and child elements of the link:/mule-user-guide/v/3.8/http-connector[HTTP Connector].
...
Required: no +
Default: none
|clientSocketProperties-ref |Reference to a link:/mule-user-guide/v/3.8/tcp-transport-reference#client-socket-properties[TCP Client Socket properties element]. +
Type: string +
Required: no +
Default: none
