...
== Version 1.22.0 - September 9, 2017

The Analytics release introduces scalability improvements over Analytics Events API. It's expected than up to 5 minutes delay might be experienced to new events will be avaiable.
