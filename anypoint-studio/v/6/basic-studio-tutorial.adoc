...
+
. In the canvas select the Http connector. In HTTP property tab below canvas go to General Settings, click the green plus sign to the right of *Connector Configuration*:
+
